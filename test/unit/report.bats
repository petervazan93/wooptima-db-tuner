...
@test "fleet-v3 localizes displays while analysis and canonical proposals stay invariant" {
    ...
    grep -Fx '_Generated: 2026-08-03T12:00:00Z | Wooptima DB Tuner 0.4.0_' "$DBTUNE_STATE_DIR/report.md"
    ...
    grep -F '# Generated by Wooptima DB Tuner 0.4.0 at 2026-08-03T12:00:00Z.' "$DBTUNE_STATE_DIR/proposed-99-zz-tuning.cnf"
    ...
    grep -Fx '_Vygenerované: 2026-08-03T12:00:00Z | Wooptima DB Tuner 0.4.0_' "$DBTUNE_STATE_DIR/report.md"
    ...
    cmd_propose >/dev/null
    grep -F '# Vygeneroval Wooptima DB Tuner 0.4.0 dňa 2026-08-03T12:00:00Z.' "$DBTUNE_STATE_DIR/proposed-99-zz-tuning.cnf"
